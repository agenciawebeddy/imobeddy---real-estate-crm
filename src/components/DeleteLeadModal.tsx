...
const DeleteLeadModal: React.FC<DeleteLeadModalProps> = ({ isOpen, onClose, onConfirm, isLoading }) => {
      ...
      <div className="bg-brand-primary p-8 rounded-2xl border border-brand-accent/20 shadow-lg w-full max-w-md relative">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex justify-center space-x-4 w-full">
            ...
            <button onClick={onConfirm} disabled={isLoading} className="flex-1 bg-red-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50">
