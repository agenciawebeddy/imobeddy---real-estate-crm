...
const DeleteListingModal: React.FC<DeleteListingModalProps> = ({ isOpen, onClose, onConfirm, isLoading }) => {
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center">
      <div className="bg-brand-primary p-8 rounded-2xl border border-brand-accent/20 shadow-lg w-full max-w-md relative">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold text-brand-primary mb-2">Excluir Imóvel</h2>
          <p className="text-brand-light mb-6">Você tem certeza que deseja excluir este imóvel? Esta ação não pode ser desfeita.</p>
